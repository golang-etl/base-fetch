...
import (
	...
	logininterfaces "github.com/golang-etl/base-fetch/src/providers/login/interfaces"
	loginpreparers "github.com/golang-etl/base-fetch/src/providers/login/preparers"
	loginresponses "github.com/golang-etl/base-fetch/src/providers/login/responses"
	loginsteps "github.com/golang-etl/base-fetch/src/providers/login/steps"
...
func (provider LoginProvider) GetLogin(shared *packagegeneralinterfaces.Shared, originalInputData logininterfaces.InputData) packagehttpinterfaces.Response {
	...
	userToken := loginsteps.CreateUserToken(provider.UserTokenModel, extra)
